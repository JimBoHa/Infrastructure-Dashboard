...
from generated_api.models.setup_credential import SetupCredential
...
class SetupCredentialsResponse(BaseModel):
    ...
    """ # noqa: E501
    credentials: List[SetupCredential]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetupCredentialsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetupCredentialsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "credentials": [SetupCredential.from_dict(_item) for _item in obj["credentials"]] if obj.get("credentials") is not None else None
        })
        return _obj

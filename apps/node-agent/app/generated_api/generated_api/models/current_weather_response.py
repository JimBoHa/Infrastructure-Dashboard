...
from generated_api.models.current_weather_metric import CurrentWeatherMetric
...
class CurrentWeatherResponse(BaseModel):
    ...
    """ # noqa: E501
    fetched_at: StrictStr
    latitude: Union[StrictFloat, StrictInt]
    longitude: Union[StrictFloat, StrictInt]
    metrics: Dict[str, CurrentWeatherMetric]
    observed_at: StrictStr
    provider: StrictStr
    __properties: ClassVar[List[str]] = ["fetched_at", "latitude", "longitude", "metrics", "observed_at", "provider"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CurrentWeatherResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CurrentWeatherResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "metrics": dict(
                (_k, CurrentWeatherMetric.from_dict(_v))

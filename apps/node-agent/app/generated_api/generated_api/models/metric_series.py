...
from generated_api.models.metric_point import MetricPoint
...
class MetricSeries(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["label", "points", "sensor_id", "sensor_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "label": obj.get("label"),
            "points": [MetricPoint.from_dict(_item) for _item in obj["points"]] if obj.get("points") is not None else None,

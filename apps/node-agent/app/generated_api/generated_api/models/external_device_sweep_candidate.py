...
class ExternalDeviceSweepCandidate(BaseModel):
    """
    ExternalDeviceSweepCandidate
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["display_name", "host", "model_id", "notes", "protocols", "vendor_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExternalDeviceSweepCandidate from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.vendor_id is None and "vendor_id" in self.model_fields_set:
            _dict['vendor_id'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExternalDeviceSweepCandidate from a dict"""
        if obj is None:
            return None

...
class AnalyticsFeedStatusEntry(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["details", "last_seen", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnalyticsFeedStatusEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnalyticsFeedStatusEntry from a dict"""
        if obj is None:
            return None

...
class PredictiveConfigUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["api_base_url", "api_token", "enabled", "model"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PredictiveConfigUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PredictiveConfigUpdate from a dict"""
        if obj is None:
            return None

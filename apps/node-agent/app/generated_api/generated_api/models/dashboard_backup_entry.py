...
class DashboardBackupEntry(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["captured_at", "id", "node_id", "node_name", "path", "size_bytes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DashboardBackupEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DashboardBackupEntry from a dict"""
        if obj is None:
            return None

...
class ForecastIngestItem(BaseModel):
    """
    ForecastIngestItem
    """ # noqa: E501
    var_field: StrictStr = Field(alias="field")
    horizon_hours: Optional[StrictInt] = None
    recorded_at: Optional[StrictStr] = None
    value: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["field", "horizon_hours", "recorded_at", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ForecastIngestItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ForecastIngestItem from a dict"""
        if obj is None:
            return None

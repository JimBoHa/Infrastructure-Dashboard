...
class AnalysisJobProgress(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["completed", "message", "phase", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnalysisJobProgress from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnalysisJobProgress from a dict"""
        if obj is None:
            return None

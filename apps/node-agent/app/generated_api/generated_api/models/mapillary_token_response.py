...
class MapillaryTokenResponse(BaseModel):
    """
    MapillaryTokenResponse
    """ # noqa: E501
    access_token: Optional[StrictStr] = None
    configured: StrictBool
    __properties: ClassVar[List[str]] = ["access_token", "configured"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MapillaryTokenResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MapillaryTokenResponse from a dict"""
        if obj is None:
            return None

...
class IncidentsListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["incidents", "next_cursor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IncidentsListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IncidentsListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "incidents": [IncidentResponse.from_dict(_item) for _item in obj["incidents"]] if obj.get("incidents") is not None else None,

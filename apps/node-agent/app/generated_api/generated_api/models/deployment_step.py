...
from generated_api.models.step_status import StepStatus
...
class DeploymentStep(BaseModel):
    ...
    status: StepStatus
    __properties: ClassVar[List[str]] = ["finished_at", "logs", "name", "started_at", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeploymentStep from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeploymentStep from a dict"""
        if obj is None:
            return None

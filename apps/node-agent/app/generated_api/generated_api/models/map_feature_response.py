...
class MapFeatureResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "geometry", "id", "node_id", "properties", "sensor_id", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MapFeatureResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MapFeatureResponse from a dict"""
        if obj is None:
            return None

...
class PvForecastCheckResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["checked_at", "place", "status", "timezone"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PvForecastCheckResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PvForecastCheckResponse from a dict"""
        if obj is None:
            return None

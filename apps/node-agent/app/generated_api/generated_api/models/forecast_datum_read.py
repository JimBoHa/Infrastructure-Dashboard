...
class ForecastDatumRead(BaseModel):
    """
    ForecastDatumRead
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["field", "horizon_hours", "id", "recorded_at", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ForecastDatumRead from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ForecastDatumRead from a dict"""
        if obj is None:
            return None
